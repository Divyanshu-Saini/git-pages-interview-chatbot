...
module.exports = "<!-- <div class=\"container deep-orange lighten-1\"> -->\r\n<div class=\"navbar-fixed deep-orange lighten-1\" id=\"myHeader\">\r\n  <div class=\"row\">\r\n    <div class=\"col s12 m12\">\r\n      <h3 class=\"center\">Interview</h3>\r\n    </div>\r\n  </div>\r\n</div>\r\n<div #scrollMe class=\"content\" style=\"overflow:scroll; height:400px;overflow-x: hidden;\">\r\n  <div class=\"row\">\r\n    <div class=\"col 10 m8 offset-s1 offset-m2\">\r\n      <ng-container *ngFor=\"let message of messages | async\">\r\n        <div id=\"msg\" class=\"message\" [ngClass]=\"{ 'from': message.sentBy === 'bot',\r\n          'to':   message.sentBy === 'user' }\" >\r\n          {{message.content}}\r\n        </div>\r\n      </ng-container>\r\n    </div>\r\n  </div>\r\n</div>\r\n<div class=\"footer\">\r\n  <div class=\"row\">\r\n    <div class=\"col s7 m7 offset-s1 offset-m1\">\r\n      <label for=\"nameField\">Your Message</label>\r\n      <input type=\"text\" [(ngModel)]=\"formValue\" (keyup.enter)=\"sendMessage()\">\r\n    </div>\r\n    <div class=\"col s1 m1\">\r\n      <button class=\"btn-floating btn-medium blue\" (click)=\"activateSpeechSearch()\" [disabled]=\"!showSearchButton\">\r\n        <i class=\"large material-icons\">mic</i>\r\n      </button>\r\n    </div>\r\n    <div class=\"col s1 m1\">\r\n      <button class=\"btn-floating btn-medium green\" (click)=\"restart()\">Restart\r\n      </button>\r\n    </div>\r\n    <div class=\"col s1 m1\">\r\n      <button class=\"btn-floating btn-medium red \" (click)=\"exit()\">\r\n        Exit\r\n      </button>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<!-- <div class=\"header\" id=\"myHeader\">\r\n    <div class=\"row\">\r\n        <div class=\"col s12 m12\">\r\n          <h1>CHATBOT</h1>\r\n        </div>\r\n      </div>\r\n</div>\r\n\r\n<div class=\"content\">\r\n<div class=\"row\">\r\n  <div class=\"col s8 m6 offset-s2 offset-m3\">\r\n    <ng-container *ngFor=\"let message of messages | async\">\r\n      <div class=\"message\" [ngClass]=\"{'from':message.sentBY === 'bot','to':message.sentBy === 'user'}\">\r\n        {{message.content}}\r\n      </div>\r\n    </ng-container>\r\n  </div>\r\n</div>\r\n</div>\r\n\r\n<div class=\"footer\">\r\n  <div class=\"row\">\r\n    <div class=\"col s9 m9 offset-s1 offset-m1\">\r\n      <label for=\"nameField\">Your Message</label>\r\n      <input type=\"text\" [(ngModel)]=\"formValue\" (keyup.enter)=\"sendMessage()\">\r\n    </div>\r\n    <div class=\"col s1 m1\">\r\n      <button class=\"btn-floating btn-large red\" (click)=\"activateSpeechSearch()\" [disabled]=\"!showSearchButton\">\r\n        <i class=\"large material-icons\">mic</i>\r\n      </button>\r\n    </div>\r\n  </div>\r\n</div> -->"
...
var ChatDialogComponent = (function () {
    ...
    ChatDialogComponent.prototype.restart = function () {
    ...
    ChatDialogComponent.prototype.speak = function (text) {
        console.log(text);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__speech_service__ = __webpack_require__("../../../../../src/app/chat/speech.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatService = (function () {
    function ChatService(speechService) {
        this.speechService = speechService;
        this.token = __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].dialogflow.angularBot_Divyanshu;
    ...
    ChatService.prototype.converse = function (msg) {
        ...
        return this.client.textRequest(msg)
            ...
            _this.speechService.synthVoice(speech);
...
ChatService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__speech_service__["a" /* SpeechService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__speech_service__["a" /* SpeechService */]) === "function" && _a || Object])
], ChatService);
...
var SpeechService = (function () {
    ...
    SpeechService.prototype.synthVoice = function (botText) {
...
var environment = {
    production: false,
    dialogflow: {
        angularBot_Bhavik: '734d75343a474dec864092239fb3b383',
        angularBot_Divyanshu: '84cd0e73a8644e57bebf061e25327059'
    }
};
